...
{
    public class EntityBusinessTransactionConfigurationReportMap : CsvClassMap<EntityBusinessTransactionConfiguration>
    {
        public EntityBusinessTransactionConfigurationReportMap()
        {
            int i = 0;
