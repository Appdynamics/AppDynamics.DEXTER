...
{
    public class ReportUsersGroupsRolesAndPermissions : JobStepReportBase
    {
        #region Constants for Users, Groups, Roles and Permissions Report contents
        ...
        public override bool ShouldExecute(JobConfiguration jobConfiguration)
        {
            ...
            logger.Trace("Output.Snapshots={0}", jobConfiguration.Output.UsersGroupsRolesPermissions);
            loggerConsole.Trace("Output.Snapshots={0}", jobConfiguration.Output.UsersGroupsRolesPermissions);
